...
namespace Project.Migrations
{
    ...
    [Migration("20201227115553_UpdateVPSStates")]
    partial class UpdateVPSStates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Models.ServerData", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("IPv4Blocked")
                        .HasColumnType("bit");

                    b.Property<string>("IPv4DNSPointer")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IPv6")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IPv6Blocked")
                        .HasColumnType("bit");

                    b.Property<string>("IPv6DNSPointer")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Project.Models.VPS", b =>
                {
                    ...
                    b.Property<string>("ServerDataId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ServerDataId")
                        .IsUnique()
                        .HasFilter("[ServerDataId] IS NOT NULL");
            ...
            modelBuilder.Entity("Project.Models.VPS", b =>
                {
                    ...
                    b.HasOne("Project.Models.ServerData", "ServerData")
                        .WithOne("VPS")
                        .HasForeignKey("Project.Models.VPS", "ServerDataId");
